...
{
    void FootTrajectory::computeSwingTrajectoryBezier(double swingProgression, double swingTime)
    {
        for (int i = 0; i < 2; i++)
        {
    ...
    double FootTrajectory::cubicBezierFirstDerivative(double y0, double yf, double x)
    {
        double yDiff = yf - y0;
    ...
    double FootTrajectory::cubicBezierSecondDerivative(double y0, double yf, double x)
    {
        double yDiff = yf - y0;
