/*
 * Copied from the header_only branch of:
 * https://github.com/gabrielliew/Save-and-Load-Eigen-Cpp-Matrices-Arrays-to-and-from-CSV-files/tree/header_only
 *
...
Eigen::Matrix<T, -1, -1> openData(std::string fileToOpen) {
  ...
  return Eigen::Map<Eigen::Matrix<T, -1, -1, Eigen::RowMajor>>(
