...
public:
  ...
  void setInitialPosition(Eigen::Vector3d p0) { p0_ = p0; }

  void setFinalPosition(Eigen::Vector3d pf) { pf_ = pf; }

  void setHeight(double h) { height_ = h; }

  Eigen::Vector3d getPosition() { return p_; }

  Eigen::Vector3d getVelocity() { return v_; }

  Eigen::Vector3d getAcceleration() { return a_; }
