...
namespace FixedGait
{
    ...
    public:
         ...
         */
        Gait(uint numLegs, uint numSegments, double gaitDuration, double contactDuration, std::vector<int> offset);
         ...
         * @return std::vector<double> The array containing swing progression of leg in [0.0,1.0] range
         */
         ...
         *
         * @param timeFromStart Takes the time from start to calculate the contact progression of each leg
         * @return std::vector<double> The array containing contact progression of leg in [0.0,1.0] range
         */
        std::vector<double> getContactProgression(uint64_t timeFromStart);

        /**
         * @brief Get the Gait Table of the robot for Model Predictive Control (MPC) calculation
         *
         * @param timeFromStart Takes the time from start to calculate the contact progression of each leg
         * @return std::vector<bool> Returns a vector with size number of legs * number of gait segments, the value of 1 indicates contact and 0 indicates swing
         */
    ...
    private:
        ...
        /**
         * @brief The duration of a single segment of gait cycle, all duration types should be multiples of this value
         *
         */
        uint64_t singleSegmentNs_;

        /**
         * @brief The offset of each leg in the gait cycle in segments, 0 indicates the leg starts contact at start of gait cycle
         *
         */
